<div>
  {/* Mirrored from demo.themewinter.com/html/digiqole/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 24 May 2020 15:57:22 GMT */}
  {/* Basic Page Needs
	================================================== */}
  <meta charSet="utf-8" />
    ...
    <div className="container">
      <div className="row ts-gutter-30">
        <div className="col-lg-8">
          ...
          <p align="justify">
            <b>linuxfossangola.ao</b> é um blog iniciado em 31 de Julho de 2020.{" "}
          </p>{" "}
          <p align="justify">
            ...
            Nosso foco é escrever artigos que o ensinem ou o ajudem a resolver
            um problema para uso de aspirantes como você e eu.{" "}
          </p>
          <p align="justify">
            {" "}
            Associado a este blog teremos o <b>plus.linuxfossangola.ao</b>,
            criado com intuito de manter uma comunidade angolana virada a Free
            Open Source Software, teremos discussões de divesos assuntos,
            resoluções de problemas e etc.{" "}
          </p>
          <p />
        </div>
        {/* col-lg-8 */}
